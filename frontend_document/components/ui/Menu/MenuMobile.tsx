            ...
            icon: (
              ...
              >
                <path
                  ...
                  strokeWidth={2}
                  d="M12 8v4m0 0v4m0-4h4m-4 0H8m6 8H6a2 2 0 01-2-2V6a2 2 0 012-2h12a2 2 0 012 2v12a2 2 0 01-2 2h-6z"
                />
              </svg>
            ),
          },
        ...
        <span className="text-xl">
          <i className="anticon anticon-trophy">
            <svg
              ...
              aria-hidden="true"
            >
              <path d="M908 312h-68.2c-4.4-36.6-16.7-70.7-35.7-100.2-2.9-4.5-7.9-7.2-13.2-7.2H232.1c-5.3 0-10.3 2.7-13.2 7.2-19 29.5-31.3 63.6-35.7 100.2H116c-4.4 0-8 3.6-8 8v56c0 110.2 89.8 200 200 200 9.1 0 18.1-.7 27-2.1 31.1 38.7 76.2 65.2 127 69.5V792H376c-4.4 0-8 3.6-8 8v56c0 4.4 3.6 8 8 8h272c4.4 0 8-3.6 8-8v-56c0-4.4-3.6-8-8-8H554v-148.6c50.8-4.3 95.9-30.8 127-69.5 8.9 1.4 17.9 2.1 27 2.1 110.2 0 200-89.8 200-200v-56c0-4.4-3.6-8-8-8zm-728 64v-40h56.2c-2.1 13.1-3.2 26.7-3.2 40.5 0 53.7 17.6 103.3 47.3 142.7C186.2 504.2 180 482.7 180 464zm332 184c-97.2 0-176-78.8-176-176 0-97.2 78.8-176 176-176s176 78.8 176 176c0 97.2-78.8 176-176 176zm332-184c0 18.7-6.2 40.2-23.5 56.2 29.7-39.4 47.3-89 47.3-142.7 0-13.8-1.1-27.4-3.2-40.5H908v40z"></path>
            </svg>
          </i>
        </span>
      ),
  ...
  return (
    <>
      ...
      >
        {/* Custom Header */}
        <div
          className={`relative p-6 bg-gradient-to-br from-white/90 to-gray-50/90 backdrop-blur-sm border-b border-gray-200/50 transition-all duration-500 ${
              ...
              >
                ...
                >
                  ...
                  <div className="absolute inset-0 rounded-lg overflow-hidden">
                    <div
                      className={`absolute inset-0 bg-gradient-to-r from-blue-400/20 to-purple-400/20 scale-0 transition-transform duration-300 ease-out rounded-lg ${
                        activeItem === item.key
                          ? 'scale-150'
                  ...
                  <span
                    className={`font-semibold transition-all duration-300 z-10 relative ${
                      activeTab === item.key
              ...
              {isLoggedIn ? (
                ...
                >
                  ...
                  <svg
                    ...
                    width={12}
                    fill="none"
                    className="mt-0.5 ml-2 -mr-1 stroke-gray-900 stroke-2 transition-all duration-300"
                  >
                    <path
                      d="M0 5h7"
        ...
        <div
          className={`absolute bottom-0 left-0 right-0 p-6 bg-gradient-to-t from-white/95 to-transparent backdrop-blur-sm border-t border-gray-200/50 transition-all duration-700 ${
            isVisible ? 'translate-y-0 opacity-100' : 'translate-y-4 opacity-0'
          }`}
      ...
      <style jsx global>{`
        ...
        .ant-drawer.mobile-menu-drawer.ant-drawer-open
